...
fetch('http://app.calltrackingnow.com/admin/controllers/extensions/extensions_controller.php')
    .then(res => res.json())
    .then((out) => {
        ...
        jQuery("#jqgrid").jqGrid({
			...
			editurl : "http://app.calltrackingnow.com/admin/controllers/extensions/extensions_controller.php?action=upd_ext",
			mtype : "POST",
