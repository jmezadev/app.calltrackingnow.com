...
//si le pongo la url absoluta también se daña, da error interno del servidor (500)
...
//si le pongo la dirección absoluta no funciona
...
<?php
	...
	//si acá pongo la ruta absoluta o la relativa con los ../../../ deja de mostrar la gráfica, en el contenedor igual no la muestra
?>
...
function alerta(){
  ...
  //   };
	setTimeout(load_the_charts, 2000);
