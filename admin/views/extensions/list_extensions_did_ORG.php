...
<script type="text/javascript">
    ...
    .then((out) => {
        ...
        jQuery("#jqgrid").jqGrid({
            ...
            datatype: 'local',
            height: 'auto',
            colNames: ['Actions', 'Ext', 'Server', 'ExtID', 'Context', 'Login', 'Password', 'Transport', 'Date Created'],
            colModel: [
    ...
    $("#deleteButton").on('click', function (event) {
        ...
        $.ajax({
            url: '../admin/controllers/extensions/extensions_controller.php?action=del_ext',
            type: 'POST',
            data: form.serialize(),
