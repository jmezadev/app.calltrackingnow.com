            ...
            <div class="widget-body col-lg-12">
              ...
              <div class="jarviswidget" id="wid-id-4" data-widget-colorbutton="false" data-widget-fullscreenbutton="false" data-widget-editbutton="false" data-widget-sortable="false">
                ...
                <header>
                  ...
                  <h2><i class="fa fa-lg fa-fw fa-bar-chart-o"></i> Action Accuracy / Actual Period</h2>
                  ...
                  <div class="widget-body">
                    ...
                    <canvas id="doughnutChart" height="100"></canvas>
                      <ul class="piechart-info">
                        <li>Action 30%</li>
                        <li>No Action 70%</li>
                        <li class="piechart-info-score">Accuracy Score: 10 / 30</li>
                        <li>From Juny to July / 2018</li>
                      </ul>
                  </div>
                  <!-- end widget content -->
...
<div class="widget-body">
              <div class="jarviswidget" id="wid-id-4" data-widget-colorbutton="false" data-widget-fullscreenbutton="false" data-widget-editbutton="false" data-widget-sortable="false">
                ...
                <header>
                  ...
                  <h2><i class="fa fa-lg fa-fw fa-bar-chart-o"></i> Agent Accuracy / Actual Period</h2>

                </header>

              <div class="easy-pie-chart txt-color-blue easyPieChart center-flex-hd" data-percent="36" data-pie-size="150">
          ...
          <!-- end widget content -->
          <div class="widget-body col-lg-5">
            <table class="table table-bordered" >
              <thead>
                <tr>
                  <th colspan="4">Top Keywords Clients in Call</th>
                </tr>
              </thead>
              <thead>
                <tr>
          ...
          <!-- end widget content -->
          <!-- end widget content -->
          <div class="widget-body col-lg-4">
            ...
            <table class="table table-bordered">
              ...
              <thead>
                  ...
                  <tr>
                    <th colspan="4">Top Keywords Agents in Call</th>
                  </tr>
                <tr>
                  <th>Keyword</th>
                  <th>Campaign</th>
              ...
              <tbody>
                <tr>
                  <td>Was clear the information?</td>
                  <td>Corolla</td>
                  <td class="text-center"> 16 / 500</td>
                  <td class="text-center">4</td>
                </tr>
                <tr>
                  <td>Do you want to buy?</td>
                  <td>Corolla</td>
                  <td class="text-center">10 / 500</td>
                  <td class="text-center">7</td>
                </tr>
                <tr>
                  <td>When do you appointment?</td>
                  <td>Camry</td>
                  <td class="text-center">8 / 500</td>
                  <td class="text-center">4</td>
                </tr>
      ...
      <div class="center-flex-hd">
        ...
        <section class="col-lg-2">
          ...
          <div class="widget-body col-lg-12">
            ...
            <!-- Widget ID (each widget will need unique ID)-->
            <div class="jarviswidget" id="wid-id-42" data-widget-colorbutton="false" data-widget-fullscreenbutton="false" data-widget-editbutton="false" data-widget-sortable="false">
              <!-- widget options:
                usage: <div class="jarviswidget" id="wid-id-0" data-widget-editbutton="false">
              ...
              <header>
                ...
                <h2><i class="fa fa-lg fa-fw fa-bar-chart-o"></i> Users</h2>
              ...
              <div>
                ...
                <div class="widget-body">
                  ...
                  <!-- this is what the user will see -->
                  <canvas id="doughnutChart1" height="300"></canvas>
                  <ul class="piechart-info">
                    <li>Active 30%</li>
                    <li>Inactive 70%</li>
                    <li class="piechart-info-score">Total: 800</li>
                    <li>From Juny to July / 2018</li>
                  </ul>
          ...
          <div class="widget-body col-lg-12">
            ...
            <div class="jarviswidget" id="wid-id-42" data-widget-colorbutton="false" data-widget-fullscreenbutton="false" data-widget-editbutton="false" data-widget-sortable="false">
              ...
              <header>
                ...
                <h2><i class="fa fa-lg fa-fw fa-bar-chart-o"></i> Campaigns</h2>
              ...
              <div>
                ...
                <div class="widget-body">
                  ...
                  <!-- this is what the user will see -->
                  <canvas id="doughnutChart2" height="300"></canvas>
                  <ul class="piechart-info">
                    <li>Active 30%</li>
                    <li>Inactive 70%</li>
                    <li class="piechart-info-score">Total: 800</li>
          ...
          <div class="widget-body col-lg-12">
            ...
            <div class="jarviswidget" id="wid-id-42" data-widget-colorbutton="false" data-widget-fullscreenbutton="false" data-widget-editbutton="false" data-widget-sortable="false">
              ...
              <header>
                ...
                <h2><i class="fa fa-lg fa-fw fa-bar-chart-o"></i> Lists</h2>
              ...
              <div>
                ...
                <div class="widget-body">
                  ...
                  <!-- this is what the user will see -->
                  <canvas id="doughnutChart3" height="300"></canvas>
                  <ul class="piechart-info">
                    <li>Active 30%</li>
                    <li>Inactive 70%</li>
                    <li class="piechart-info-score">Total: 800</li>
          ...
          <div class="widget-body col-lg-12">
            ...
            <div class="jarviswidget" id="wid-id-42" data-widget-colorbutton="false" data-widget-fullscreenbutton="false" data-widget-editbutton="false" data-widget-sortable="false">
              ...
              <header>
                ...
                <h2><i class="fa fa-lg fa-fw fa-bar-chart-o"></i> In-Groups</h2>
              ...
              <div>
                ...
                <div class="widget-body">
                  ...
                  <!-- this is what the user will see -->
                  <canvas id="doughnutChart4" height="300"></canvas>
                  <ul class="piechart-info">
                    <li>Active 30%</li>
                    <li>Inactive 70%</li>
                    <li class="piechart-info-score">Total: 800</li>
          ...
          <div class="widget-body col-lg-12">
            ...
            <div class="jarviswidget" id="wid-id-42" data-widget-colorbutton="false" data-widget-fullscreenbutton="false" data-widget-editbutton="false" data-widget-sortable="false">
              ...
              <header>
                ...
                <h2><i class="fa fa-lg fa-fw fa-bar-chart-o"></i> DIDs</h2>
              ...
              <div>
                ...
                <div class="widget-body">
                  ...
                  <!-- this is what the user will see -->
                  <canvas id="doughnutChart5" height="300"></canvas>
                  <ul class="piechart-info">
                    <li>Active 30%</li>
                    <li>Inactive 70%</li>
                    <li class="piechart-info-score">Total: 800</li>
...
<!--beging graphics Diegooo-->

<!--end graphics Diegooo-->

</section>
<!-- ==========================CONTENT STARTS HERE GRAPHICS REFERENCE ========================== -->
...
<script defer>
	...
	title.innerHTML = "<h1 class=\"page-title txt-color-blueDark\"><i class=\"fa fa-lg fa-fw fa-home\"></i> Dashboard / <span> Analytics dashboard</span></h1>";
</script>
...
function alerta(){
  ...
  //   };
	setTimeout(load_the_charts, 1000);
	function load_the_charts() {
		//alert("");
	      // window.myLine = new Chart(document.getElementById("lineChart"), LineConfig);
	      // window.myBar = new Chart(document.getElementById("barChart"), {
	      //     type: 'bar',
	   ...
	   //   window.myRadar = new Chart(document.getElementById("radarChart"), RadarConfig);
		window.myDoughnut = new Chart(document.getElementById("doughnutChart"), DoughtnutConfig);
    window.myDoughnut = new Chart(document.getElementById("doughnutChart1"), DoughtnutConfig1);
    window.myDoughnut = new Chart(document.getElementById("doughnutChart2"), DoughtnutConfig2);
    window.myDoughnut = new Chart(document.getElementById("doughnutChart3"), DoughtnutConfig3);
    window.myDoughnut = new Chart(document.getElementById("doughnutChart4"), DoughtnutConfig4);
    window.myDoughnut = new Chart(document.getElementById("doughnutChart5"), DoughtnutConfig5);
	//	window.myPolarArea = Chart.PolarArea(document.getElementById("polarChart"), PolarConfig);
		window.myPie = new Chart(document.getElementById("pieChart"), PieConfig);
	  };
}
...
<!-- *************************** PAGE RELATED PLUGIN(S) FLOT CHARTS ********************************* -->
...
<script type="text/javascript">
  ...
  setTimeout(load_float_charts, 3000);


  function load_float_charts(){
    //alert("the function to load the floats...");
