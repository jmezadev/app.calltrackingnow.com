			...
			<div class="col-xs-12 col-sm-5 col-md-5 col-lg-8">
				<ul id="sparks" class="">
					<li class="sparks-info">
                                                ...
                                                <h5> Call InComing <span class="txt-color-blue"><i class="fa fa-arrow-circle-down"></i>&nbsp;5,540</span></h5>
						<div class="sparkline txt-color-blue hidden-mobile hidden-md hidden-sm">
							1300, 1877, 2500, 2577, 2000, 2100, 3000, 2700, 3631, 2471, 2700, 3631, 2471
						</div>
					</li>
					<li class="sparks-info">
						<h5> Call OutComing <span class="txt-color-green"><i class="fa fa-arrow-circle-up"></i>&nbsp;2,350</span></h5>
						<div class="sparkline txt-color-green hidden-mobile hidden-md hidden-sm">
							110,150,300,130,400,240,220,310,220,300, 270, 210
						</div>
					</li>
					<li class="sparks-info">
						<h5> Total Time OnLine <span class="txt-color-orange"><i class="fa fa-clock-o"></i>&nbsp;3 Days, 20:15:12</span></h5>
...
<script>
        ...
        function LoadContent(content_file)
        {
            ...
            // Load Page
            $("#main_content").load(content_file);
        }
