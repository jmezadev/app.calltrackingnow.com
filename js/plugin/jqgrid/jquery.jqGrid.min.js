...
function tableToGrid(a, b) {
    jQuery(a).each(function () {
        if (!this.grid) {
            ...
            var a = jQuery(this).width(), c = jQuery("tr td:first-child input[type=checkbox]:first", jQuery(this)),
                d = jQuery("tr td:first-child input[type=radio]:first", jQuery(this)), e = c.length > 0,
                f = !e && d.length > 0, g = e || f, h = [], i = [];
...
!function ($) {
    ...
    $.jgrid = $.jgrid || {}, $.extend($.jgrid, {
        ...
        return this.each(function () {
            if (!this.grid) {
                var b = $.extend(!0, {
                    ...
                    "headers": [], "cols": [], "footers": [], "dragStart": function (a, d, e) {
                        ...
                        if (this.resizing) {
                            var c, d, e = a.clientX - this.resizing.startX, f = this.headers[this.resizing.idx],
                        ...
                        if (a) {
                            ...
                            if (e) {
                                d.prevRowHeight = e;
                                var h, i, j, k = b.rowNum, l = d.scrollTop = d.bDiv.scrollTop,
                                    m = Math.round(f.position().top) - l, n = m + f.height(), o = e * k;
                ...
                var j = ["shiftKey", "altKey", "ctrlKey"], k = function (a, b) {
                    ...
                    var a, b, d, e = c.p.data.length, f = c.p.rownumbers === !0 ? 1 : 0,
                        g = c.p.multiselect === !0 ? 1 : 0, h = c.p.subGrid === !0 ? 1 : 0;
                    ...
                    var g = new Date, h = "local" !== c.p.datatype && c.p.loadonce || "xmlstring" === c.p.datatype,
                        i = "_id_", j = c.p.xmlReader, l = "local" === c.p.datatype ? "local" : "xml";
                    if (h && (c.p.data = [], c.p._index = {}, c.p.localReader.id = i), c.p.reccount = 0, $.isXMLDoc(a)) {
                        ...
                        var m, n, u, w, x, y, z, A, B, C, D = $(c), E = 0, F = c.p.multiselect === !0 ? 1 : 0, G = 0,
                            H = c.p.rownumbers === !0 ? 1 : 0, I = [], J = {}, K = [],
                        ...
                        var N, O = M.length, P = 0, Q = [], R = parseInt(c.p.rowNum, 10),
                    ...
                    if (a) {
                        ...
                        var m, n, u, w, x, y, z, A, B, C, D, E, F = $(c), G = 0, H = [], I = c.p.multiselect ? 1 : 0,
                            J = c.p.subGrid === !0 ? 1 : 0, K = c.p.rownumbers === !0 ? 1 : 0, L = s(I + J + K),
                            M = r(i), N = {}, O = [], P = c.p.altRows === !0 ? c.p.altclass : "";
                    ...
                    if ($.isArray(c.p.data)) {
                        ...
                        var s = p.select(), t = parseInt(c.p.rowNum, 10), u = s.length, v = parseInt(c.p.page, 10),
                            w = Math.ceil(u / t), x = {};
                    ...
                    var d, e, f, g, h, i, j, l, m = "", n = c.p.pager ? "_" + $.jgrid.jqID(c.p.pager.substr(1)) : "",
                    ...
                    var d, e, g, h, i, j, l,
                        m = "<td class='ui-pg-button ui-state-disabled' style='width:4px;'><span class='ui-separator'></span></td>",
                        n = "",
                    ...
                    var d, e, f = "", g = c.p.colModel, h = !1, i = c.p.frozenColumns ? b : c.grid.headers[a].el,
                        j = "";
                    ...
                    var a, b, e, f, g = 0, h = $.jgrid.cell_width ? 0 : k(c.p.cellLayout, 0), i = 0,
                        j = k(c.p.scrollOffset, 0), l = !1, m = 0;
                ...
                var N, O, P, Q, R, S, T, U, V, W = "<thead><tr class='ui-jqgrid-labels' role='rowheader'>", X = "",
                    Y = "", Z = [], _ = [], aa = [];
                if (c.p.shrinkToFit === !0 && c.p.forceFit === !0) for (e = c.p.colModel.length - 1; e >= 0; e--) if (!c.p.colModel[e].hidden) {
                    c.p.colModel[e].resizable = !1;
                    break
                }
                if ("horizontal" === c.p.viewsortcols[1] && (X = " ui-i-asc", Y = " ui-i-desc"), N = h ? "class='ui-th-div-ie'" : "", V = "<span class='s-ico' style='display:none'><span sort='asc' class='ui-grid-ico-sort ui-icon-asc" + X + " ui-state-disabled ui-icon ui-icon-triangle-1-n ui-sort-" + f + "'></span>", V += "<span sort='desc' class='ui-grid-ico-sort ui-icon-desc" + Y + " ui-state-disabled ui-icon ui-icon-triangle-1-s ui-sort-" + f + "'></span></span>", c.p.multiSort) for (Z = c.p.sortname.split(","), e = 0; e < Z.length; e++) aa = $.trim(Z[e]).split(" "), Z[e] = $.trim(aa[0]), _[e] = aa[1] ? $.trim(aa[1]) : c.p.sortorder || "asc";
                ...
                var ga = $("tr:first", W), ha = "<tr class='jqgfirstrow' role='row' style='height:auto'>";
                ...
                $(c).before(d.hDiv).click(function (a) {
                    ...
                    "height": c.p.height + (isNaN(c.p.height) ? "" : "px"), "width": d.width + "px"
                ...
                if ($(d.cDiv).append(pa).append("<span class='ui-jqgrid-title'>" + c.p.caption + "</span>").addClass("ui-jqgrid-titlebar ui-jqgrid-caption" + ("rtl" === f ? "-rtl" : "") + " ui-widget-header ui-corner-top ui-helper-clearfix"), $(d.cDiv).insertBefore(d.hDiv), c.p.toolbar[0] && (d.uDiv = document.createElement("div"), "top" === c.p.toolbar[1] ? $(d.uDiv).insertBefore(d.hDiv) : "bottom" === c.p.toolbar[1] && $(d.uDiv).insertAfter(d.hDiv), "both" === c.p.toolbar[1] ? (d.ubDiv = document.createElement("div"), $(d.uDiv).addClass("ui-userdata ui-state-default").attr("id", "t_" + this.id).insertBefore(d.hDiv), $(d.ubDiv).addClass("ui-userdata ui-state-default").attr("id", "tb_" + this.id).insertAfter(d.hDiv), ka && $(d.ubDiv).hide()) : $(d.uDiv).width(d.width).addClass("ui-userdata ui-state-default").attr("id", "t_" + this.id), ka && $(d.uDiv).hide()), c.p.toppager && (c.p.toppager = $.jgrid.jqID(c.p.id) + "_toppager", d.topDiv = $("<div id='" + c.p.toppager + "'></div>")[0], c.p.toppager = "#" + c.p.toppager, $(d.topDiv).addClass("ui-state-default ui-jqgrid-toppager").width(d.width).insertBefore(d.hDiv), E(c.p.toppager, "_t")), c.p.footerrow && (d.sDiv = $("<div class='ui-jqgrid-sdiv'></div>")[0], la = $("<div class='ui-jqgrid-hbox" + ("rtl" === f ? "-rtl" : "") + "'></div>"), $(d.sDiv).append(la).width(d.width).insertAfter(d.hDiv), $(la).append(fa), d.footers = $(".ui-jqgrid-ftable", d.sDiv)[0].rows[0].cells, c.p.rownumbers && (d.footers[0].className = "ui-state-default jqgrid-rownum"), ka && $(d.sDiv).hide()), la = null, c.p.caption) {
                    ...
                    c.p.hidegrid === !0 && ($(".ui-jqgrid-titlebar-close", d.cDiv).click(function (a) {
                        var b, e = $.isFunction(c.p.onHeaderClick),
                            f = ".ui-jqgrid-bdiv, .ui-jqgrid-hdiv, .ui-jqgrid-pager, .ui-jqgrid-sdiv", g = this;
        ...
        "getGridParam": function (a) {
            ...
            return this.each(function () {
                function d(a) {
                    var b = $(k.grid.bDiv)[0].clientHeight, c = $(k.grid.bDiv)[0].scrollTop,
                        d = $(k.rows[a]).position().top, e = k.rows[a].clientHeight;
    ...
    a.jgrid.extend({
        "getColProp": function (a) {
                ...
                if (!this.ftoolbar) {
                    var d, e = function () {
                        ...
                        d = "boolean" != typeof d ? !0 : d, a.each(c.p.colModel, function () {
                            var b,
                                d = a("#gs_" + a.jgrid.jqID(this.name), this.frozen === !0 && c.p.frozenColumns === !0 ? c.grid.fhDiv : c.grid.hDiv);
                        ...
                        k += "</ul>", a("body").append(k), a("#sopt_menu").addClass("ui-menu ui-widget ui-widget-content ui-corner-all"), a("#sopt_menu > li > a").hover(function () {
                            ...
                            var g = a(this).attr("value"), h = a(this).attr("oper");
            ...
            return void 0 === b && (b = !0), this.each(function () {
                var c, d, e, f, g, h, i, j = this, k = j.grid, l = a("table.ui-jqgrid-htable thead", k.hDiv),
                    m = j.p.colModel;
                if (k) {
            ...
            return b = a.extend({"useColSpanStyle": !1, "groupHeaders": []}, b || {}), this.each(function () {
                ...
                var c, d, e, f, g, h, i, j, k, l, m, n, o, p = this, q = 0, r = p.p.colModel, s = r.length,
                    t = p.grid.headers, u = a("table.ui-jqgrid-htable", p.grid.hDiv),
...
!function (a) {
    ...
    a.fmatter = {}, a.extend(a.fmatter, {
        ...
        var c = a(this).closest("tr.jqgrow"), d = c.attr("id"),
        ...
        var f, g, h = c.colModel.formatter, i = c.colModel.formatoptions || {}, j = /([\.\*\_\'\(\)\{\}\+\?\\])/g,
        ...
        var h = a.extend({}, void 0 !== c.colModel.formatoptions ? c.colModel.formatoptions : c.colModel.editoptions),
            i = void 0 === h.separator ? ":" : h.separator, j = void 0 === h.delimiter ? ";" : h.delimiter;
        if (h.value) {
    ...
    a.extend(a.jgrid, {
        "showModal": function (a) {
            ...
            var k = isNaN(f.dataheight) ? f.dataheight : f.dataheight + "px", l = "text-align:" + f.align + ";",
                m = "<div id='info_id'>";
                ...
                case"select":
                    ...
                    if (c.multiple === !0 ? (l = !0, h.multiple = "multiple", a(h).attr("aria-multiselectable", "true")) : l = !1, void 0 !== c.dataUrl) {
                        ...
                        i.p && i.p.idPrefix && (n = a.jgrid.stripPref(i.p.idPrefix, n)), a.ajax(a.extend({
                            ...
                            "success": function (b) {
                                var c = [], d = this.elem, e = this.vl, f = a.extend({}, this.options),
                                    h = f.multiple === !0,
                    ...
                    this.onchange = function () {
                        ...
                        for (d = 0; d < l.p.columns.length; d++) {
                            var u = void 0 === l.p.columns[d].search ? !0 : l.p.columns[d].search,
                                v = l.p.columns[d].hidden === !0, w = l.p.columns[d].searchoptions.searchhidden === !0;
    ...
    a.jgrid.extend({
        "searchGrid": function (b) {
            ...
            return d = a.extend(!0, {
                ...
                function f(c, d, e, f) {
                    ...
                    if ("_empty" !== c && (q = a(d).jqGrid("getInd", c)), a(d.p.colModel).each(function (m) {
                            if (g = this.name, h = this.editrules && this.editrules.edithidden === !0 ? !1 : this.hidden === !0 ? !0 : !1, k = h ? "style='display:none'" : "", "cb" !== g && "subgrid" !== g && this.editable === !0 && "rn" !== g) {
                                ...
                                var u = a.extend({}, this.editoptions || {}, {"id": g, "name": g}), v = a.extend({}, {
                                        "elmprefix": "",
                                        "elmsuffix": "",
                                        "rowabove": !1,
                                        "rowcontent": ""
                                    }, this.formoptions || {}), w = parseInt(v.rowpos, 10) || n + 1,
                ...
                function i() {
                    var c, e, f, i, j, k, l = [!0, "", ""], m = {}, n = o.p.prmNames,
                    ...
                    if (h(), l[0] && (m = a(o).triggerHandler("jqGridAddEditClickSubmit", [b[o.p.id], p, r]), void 0 === m && a.isFunction(b[o.p.id].onclickSubmit) && (m = b[o.p.id].onclickSubmit.call(o, b[o.p.id], p, r) || {}), l = a(o).triggerHandler("jqGridAddEditBeforeSubmit", [p, a("#" + t), r]), void 0 === l && (l = [!0, "", ""]), l[0] && a.isFunction(b[o.p.id].beforeSubmit) && (l = b[o.p.id].beforeSubmit.call(o, p, a("#" + t), r))), l[0] && !b[o.p.id].processing) {
                        ...
                        var y = a.extend({
                            ...
                            "complete": function (h, i) {
                                var k;
                                if (p[e] = o.p.idPrefix + p[e], h.status >= 300 && 304 !== h.status ? (l[0] = !1, l[1] = a(o).triggerHandler("jqGridAddEditErrorTextFormat", [h, r]), a.isFunction(b[o.p.id].errorTextFormat) ? l[1] = b[o.p.id].errorTextFormat.call(o, h, r) : l[1] = i + " Status: '" + h.statusText + "'. Error code: " + h.status) : (l = a(o).triggerHandler("jqGridAddEditAfterSubmit", [h, p, r]), void 0 === l && (l = [!0, "", ""]), l[0] && a.isFunction(b[o.p.id].afterSubmit) && (l = b[o.p.id].afterSubmit.call(o, h, p, r))), l[0] === !1) a("#FormError>td", v).html(l[1]), a("#FormError", v).show(); else if (o.p.autoencode && a.each(p, function (b, c) {
                ...
                if (o.grid && c) {
                    var p, q, r, s = o.p.id, t = "FrmGrid_" + s, u = "TblGrid_" + s, v = "#" + a.jgrid.jqID(u), w = {
                        ...
                        A = a.isFunction(b[o.p.id].onInitializeForm) ? b[o.p.id].onInitializeForm : !1, B = !0, C = 1,
                        D = 0;
            ...
            return d = a.extend(!0, {
                ...
                function f(b, c, e, f) {
                    ...
                    if (a(c.p.colModel).each(function () {
                            ...
                            if (g = this.name, n = !1, h = this.editrules && this.editrules.edithidden === !0 ? !1 : this.hidden === !0 ? !0 : !1, k = h ? "style='display:none'" : "", o = "boolean" != typeof this.viewable ? !0 : this.viewable, "cb" !== g && "subgrid" !== g && "rn" !== g && o) {
                                ...
                                var d = a.extend({}, {"rowabove": !1, "rowcontent": ""}, this.formoptions || {}),
                ...
                var j = this;
                if (j.grid && c) {
                    var k = j.p.id, l = "ViewGrid_" + a.jgrid.jqID(k), m = "ViewTbl_" + a.jgrid.jqID(k),
                ...
                this.each(function () {
                    ...
                    if (e.grid && c) {
                        var f, g, h, i, j = a.isFunction(b[e.p.id].beforeShowForm),
                            ...
                            l = a.isFunction(b[e.p.id].beforeInitData) ? b[e.p.id].beforeInitData : !1, m = e.p.id,
                            n = {}, o = !0, p = "DelTbl_" + a.jgrid.jqID(m), q = "DelTbl_" + m, r = {
                                "themodal": "delmod" + m,
                                "modalhead": "delhd" + m,
                                ...
                                if (n = {}, a.isFunction(b[e.p.id].onclickSubmit) && (n = b[e.p.id].onclickSubmit.call(e, b[e.p.id], k) || {}), a.isFunction(b[e.p.id].beforeSubmit) && (j = b[e.p.id].beforeSubmit.call(e, k)), j[0] && !b[e.p.id].processing) {
                                    ...
                                    var l = a.extend({
                                        ...
                                        "complete": function (c, g) {
                                            var h;
                                            if (c.status >= 300 && 304 !== c.status ? (j[0] = !1, a.isFunction(b[e.p.id].errorTextFormat) ? j[1] = b[e.p.id].errorTextFormat.call(e, c) : j[1] = g + " Status: '" + c.statusText + "'. Error code: " + c.status) : a.isFunction(b[e.p.id].afterSubmit) && (j = b[e.p.id].afterSubmit.call(e, c, f)), j[0] === !1) a("#DelError>td", "#" + p).html(j[1]), a("#DelError", "#" + p).show(); else {
                ...
                if (!this.nav) {
                    ...
                    if (l.grid && "string" == typeof b) {
                        ...
                        for (c.cloneToTop && l.p.toppager && (n = 2), m = 0; n > m; m++) {
                            var q, r, s,
                                t = a("<table cellspacing='0' cellpadding='0' border='0' class='ui-pg-table navtable' style='float:left;table-layout:auto;'><tbody><tr></tr></tbody></table>"),
    ...
    a.jgrid.extend({
        "editCell": function (b, c, d) {
                ...
                if (i.grid && i.p.cellEdit === !0) {
                    ...
                    if (h = i.p.colModel[c], e = h.name, "subgrid" !== e && "cb" !== e && "rn" !== e) {
                        if (g = a("td:eq(" + c + ")", i.rows[b]), h.editable !== !0 || d !== !0 || g.hasClass("not-editable-cell")) parseInt(i.p.iCol, 10) >= 0 && parseInt(i.p.iRow, 10) >= 0 && (a("td:eq(" + i.p.iCol + ")", i.rows[i.p.iRow]).removeClass("edit-cell ui-state-highlight"), a(i.rows[i.p.iRow]).removeClass("selected-row ui-state-hover")), g.addClass("edit-cell ui-state-highlight"), a(i.rows[b]).addClass("selected-row ui-state-hover"), f = g.html().replace(/\&#160\;/gi, ""), a(i).triggerHandler("jqGridSelectCell", [i.rows[b].id, e, f, b, c]), a.isFunction(i.p.onSelectCell) && i.p.onSelectCell.call(i, i.rows[b].id, e, f, b, c); else {
                            ...
                            var l = a.extend({}, h.editoptions || {}, {"id": b + "_" + e, "name": e}),
            ...
            return this.each(function () {
                ...
                if (e.grid && e.p.cellEdit === !0) {
                    if (d = e.p.savedRow.length >= 1 ? 0 : null, null !== d) {
                        var f, g, h = a("td:eq(" + c + ")", e.rows[b]), i = e.p.colModel[c], j = i.name,
                            k = a.jgrid.jqID(j);
                        switch (i.edittype) {
                            case"select":
            ...
            return this.each(function () {
                function b(b, c, e) {
                    if ("v" === e.substr(0, 1)) {
                        var f = a(d.grid.bDiv)[0].clientHeight, g = a(d.grid.bDiv)[0].scrollTop,
                    ...
                    if ("h" === e) {
                        var j = a(d.grid.bDiv)[0].clientWidth, k = a(d.grid.bDiv)[0].scrollLeft,
            ...
            return this.each(function () {
                ...
                if (d.grid) {
                    var e, f, g, h, i, j = function (b, c, e) {
                        ...
                        var e, f, g, h, i, k,
                            l = a("<table cellspacing='0' cellpadding='0' border='0'><tbody></tbody></table>"),
                            m = a("<tr></tr>");
        ...
        "setTreeNode": function (b, c) {
            ...
            return this.each(function () {
                ...
                if (d.grid && d.p.treeGrid) switch (d.p.treeGridModel) {
                    case"nested":
                        var e = d.p.treeReader.left_field, f = d.p.treeReader.right_field,
            ...
            return this.each(function () {
                ...
                if (e.grid && e.p.treeGrid) switch (e.p.treeGridModel) {
                    case"nested":
                        var f = e.p.treeReader.left_field, g = e.p.treeReader.right_field,
                            h = e.p.treeReader.level_field, i = parseInt(b[f], 10), j = parseInt(b[g], 10),
                            k = parseInt(b[h], 10);
                        a(this.p.data).each(function () {
            ...
            return this.each(function () {
                if (this.grid && this.p.treeGrid) {
                    var c = this.p.treeReader.expanded_field, d = this.p.treeReader.parent_id_field,
    ...
    a.extend(a.jgrid, {
        ...
        "groupingSetup": function () {
            ...
            return this.each(function () {
                ...
                var g, h, i = e.join("_"), j = d.minusicon, k = d.plusicon, l = a("#" + a.jgrid.jqID(b)),
                    ...
                    }, p = !1, q = c.p.frozenColumns ? c.p.id + "_frozen" : !1,
            ...
            return this.each(function () {
                ...
                var h, i, j, k = this, l = k.p.groupingView, m = "", n = "",
                ...
                s.reverse(), a.each(l.groups, function (f, t) {
                    ...
                    var v = q - 1 === t.idx;
                    if (v) {
                        var w, x, y = l.groups[f + 1], z = 0, A = t.startRow,
    ...
    a.assocArraySize = function (a) {
        ...
        "pivotSetup": function (c, d) {
            var e = [], f = [], g = [], h = [],
                i = {"grouping": !0, "groupingView": {"groupField": [], "groupSummary": [], "groupSummaryPos": []}},
                j = [], k = a.extend({
                    "rowTotals": !1,
                    "rowTotalsText": "Total",
                    "colTotals": !1,
            ...
            return this.each(function () {
                function f(b) {
                    var e, f = jQuery(g).jqGrid("pivotSetup", b, c), h = a.assocArraySize(f.summary) > 0 ? !0 : !1,
