...
<html lang="en-us" class="smart-style-1">
	<head>
		...
		<!-- Form Add Agent Styles -->
		<link rel="stylesheet" type="text/css" media="screen" href="<?php echo ASSETS_URL; ?>/css/form-add-agent.css">
		<!-- Form Add Dids Styles -->
		<link rel="stylesheet" type="text/css" media="screen" href="<?php echo ASSETS_URL; ?>/css/form-add-dids.css">
		<!-- Form Add Ext Styles -->
		<link rel="stylesheet" type="text/css" media="screen" href="<?php echo ASSETS_URL; ?>/css/form-add-ext.css">
		<!-- Form Add User Styles -->
		<link rel="stylesheet" type="text/css" media="screen" href="<?php echo ASSETS_URL; ?>/css/form-add-user.css">
	...
	<body class="desktop-detected pace-done smart-style-1 fixed-header fixed-navigation fixed-ribbon fixed-page-footer"
