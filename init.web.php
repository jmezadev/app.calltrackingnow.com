  ...
  "dashboard" => array(
        ...
        "sub" => array(
            "analytics" => array(
                ...
                'url' => 'javascript:LoadContent(\'/admin/views/dashboard/analytics_dashboard.php\');'
            )
            // "test" => array(
            //     "title" => "test",
            //     'url' => 'javascript:LoadContent(\'/admin/views/dashboard/chartjs_test.php\');'
            // ),
            // "test2" => array(
            //     "title" => "test from root",
            //     'url' => 'javascript:LoadContent(\'/chartjs_test.php\');'
            // )
        )
    ),
    "smartui" => array(
        ...
        "sub" => array(
          "general2" => array(
              ...
              'sub' => array(
                  'alert' => array(
                      'title' => 'Add',
                      'url' => 'javascript:LoadContent(\'/admin/views/users/add_users.php\');'
                  ),
                  'progress' => array(
                      'title' => 'List',
                      'url' => 'javascript:LoadContent(\'/admin/views/users/list_users.php\');'
                  )
              )
          ),
            "general" => array(
                ...
                'sub' => array(
                    'alert' => array(
                      'title' => 'Add',
                      'url' => 'javascript:LoadContent(\'/admin/views/extensions/add_extension.php\');'

                    ),
                    'progress' => array(
                      'title' => 'List',
                      'url' => 'javascript:LoadContent(\'/admin/views/extensions/list_extensions.php\');'
                    )
                ),
            ),
            "general3" => array(
                ...
                'sub' => array(
                    'alert' => array(
                        'title' => 'Add',
                        'url' => 'javascript:LoadContent(\'/admin/views/extensions/add_extension_did.php\');'
                    ),
                    'progress' => array(
                        'title' => 'List',
                        'url' => 'javascript:LoadContent(\'/admin/views/extensions/list_extensions_did.php\');'
                    )
                )
            ),
            "general5" => array(
                ...
                'sub' => array(
                    'alert' => array(
                        'title' => 'Add',
                        'url' => 'javascript:LoadContent(\'/admin/views/trunks/add_trunk.php\');'
                    ),
                    'progress' => array(
                        'title' => 'List',
                        'url' => 'javascript:LoadContent(\'/admin/views/trunks/list_trunks.php\');'
                    )
                )
            ),
            "general4" => array(
                ...
                'sub' => array(
                    'alert' => array(
                        'title' => 'Add',
                        'url' => 'javascript:LoadContent(\'/admin/views/routes/add_route.php\');'
                    ),
                    'progress' => array(
                        'title' => 'List',
                        'url' => 'javascript:LoadContent(\'/admin/views/routes/list_routes.php\');'
                    )
                )
            ),

            /*debes quitar la , si quitas lo de abajo*/
        ...
        "sub" => array(
            "general3" => array(
                ...
                'sub' => array(
                    'alert' => array(
                      'title' => 'Add',
                       'url' => 'javascript:LoadContent(\'/admin/views/agents/add_agents.php\');'
                    ),
                    'progress' => array(
                        'title' => 'List',
                        // 'url' => 'javascript:LoadContent(\'/admin/views/extensions/list_extensions.php\');'
            ...
            "general4" => array(
                ...
                'sub' => array(
                    'alert' => array(
                        'title' => 'Add',
                         'url' => 'javascript:LoadContent(\'/admin/views/campaigns/add_campaign.php\');'
                    ),
                    'progress' => array(
                        'title' => 'List',
                        'url' => 'javascript:LoadContent(\'/admin/views/campaigns/list_campaigns.php\');'
                    )
                )
            )
    ...
    "tablesCalls" => array(
        ...
        "sub" => array(
            "general26" => array(
                        'title' => 'Traffic',
                        'url' => 'javascript:LoadContent(\'/admin/views/calls/list_calls.php\');'
            )
        )
    )
    /*
